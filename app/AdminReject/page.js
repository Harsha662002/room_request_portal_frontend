  ...
  return (
    <div className="main">
      ...
      <div className="container px-4 p-3">
        ...
        <div>
          <h2 className="my-2 mt-3 text-xl font-semibold">Rejected Requests</h2>
          <div className="cards">
            <div
            ...
            >
              <div className="w-full md:w-3/5">
                <p>
                  Name of the Event:{" "}
                  <span className="event-name">XXXXXXXX</span>
                </p>
                <p>
                  Date of the Event:{" "}
                  <span className="event-date">DD/MM/YYYY</span>
                </p>
                <p>
                  Hall: <span className="event-hall">XXX</span>
                </p>
                <p>
                  Request:{" "}
                  <span className="event-request">
                    Lorem ipsum dolor sit amet consectetur adipisicing
                    elepudiandae iusto a sint, odit blanditiis amet.
                  </span>
                </p>
              </div>
              <div className="w-full md:w-3/5 mt-2">
                <div className="club-details p-1 px-5 pl-6 border-black border-2 rounded-full">
                  <p>
                    Club Name: <span className="club-name">XXX</span>
                  </p>
                  <p>
                    PIC: <span className="pic">YYY</span>
                  </p>
                </div>
              </div>
            </div>
